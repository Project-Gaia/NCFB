define(["app", "localstorage"], function(VolunteerManager){
  VolunteerManager.module("Entities", function(Entities, VolunteerManager, Backbone, Marionette, $, _){
  ...
  return VolunteerManager.Entities.configureStorage;
});
